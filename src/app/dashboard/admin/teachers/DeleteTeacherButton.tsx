...
import { deleteTeacher, type DeleteState } from "@/server/actions/admin/teachers";

const initial: DeleteState = {};

export function DeleteTeacherButton({ userId }: { userId: string }) {
  const [state, action, pending] = useActionState(deleteTeacher, initial);
